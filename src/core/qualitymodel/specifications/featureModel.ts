...
export { PROTOCOLS_SUPPORTING_TLS, QUERY_ENDPOINT_KIND, COMMAND_ENDPOINT_KIND, SEND_EVENT_ENDPOINT_KIND, SUBSCRIBE_ENDPOINT_KIND, SYNCHRONOUS_ENDPOINT_KIND, ASYNCHRONOUS_ENDPOINT_KIND, MESSAGE_BROKER_KIND, EVENT_SOURCING_KIND, VAULT_KIND, MANAGED_INFRASTRUCTURE_ENVIRONMENT_ACCESS, AUTOMATED_INFRASTRUCTURE_PROVISIONING, MANAGED_INFRASTRUCTURE_MAINTENANCE, DYNAMIC_INFRASTRUCTURE, ROLLING_UPDATE_STRATEGY_OPTIONS, BACKING_DATA_CONFIG_KIND, BACKING_DATA_LOGS_KIND, BACKING_DATA_METRICS_KIND, BACKING_DATA_SECRET_KIND, DATA_USAGE_RELATION_USAGE, DATA_USAGE_RELATION_PERSISTENCE, SERVICE_MESH_KIND,  CUSTOM_SOFTWARE_TYPE, IAC_ARTIFACT_TYPE, AUTOMATED_SCALING, getUsageRelationWeight, getEndpointKindWeight }
