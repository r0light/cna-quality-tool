...
const measures = {
    ...
    "numberOfSynchronousEndpointsOfferedByAService": {
        ...
        "calculationFormula": "|\\{ e | e \\in c.E \\land (e.kind = \"query\" \\lor e.kind = \"command\")  \\} |",
        "sources": ["Shim2008"],
        "applicableEntities": [ENTITIES.COMPONENT],
    },
    "serviceInterfaceUsageCohesion": {
        ...
        "calculationFormula": "\\frac{\\sum_{i=1}^{|C|} |\\{e | e \\in c.E \\land \\exists l (l \\in L \\land l.sourceComponent = c_i \\land l.targetEndpoint = e) \\}|}{ |\\{ c' | c' \\in C \\land \\exists l (l \\in L \\land l.sourceComponent = c' \\land l.targetEndpoint \\in c.E) \\}| \\times |c.E| }",
    ...
    "numberOfAsynchronousEndpointsOfferedByAService": {
        ...
        "calculationFormula": "|\\{ e | e \\in c.E \\land (e.kind = \"event\" \\lor e.kind = \"subscribe\")  \\}|",
    ...
    "numberOfAsynchronousOutgoingLinks": {
        ...
        "calculationFormula": "|\\{ l | l \\in L \\land l.sourceComponent = c \\land (l.targetEndpoint.kind = \"event\" \\lor l.targetEndpoint.kind = \"subscribe\")  \\}|",
        "sources": ["Apel2019", "Daniel2023"],
        "applicableEntities": [ENTITIES.COMPONENT],
    },
    "ratioOfAsynchronousOutgoingLinks": {
        ...
        "calculationFormula": "\\frac{|\\{ l | l \\in L \\land l.sourceComponent = c \\land (l.targetEndpoint.kind = \"event\" \\lor l.targetEndpoint.kind = \"subscribe\")  \\}|}{|\\{ l | l \\in L \\land l.sourceComponent = c \\}|}",
        "sources": ["Karhikeyan2012"],
        "applicableEntities": [ENTITIES.COMPONENT],
    },
    ...
    "distributedTracingSupport": {
        ...
        "calculationFormula": "\\frac{ |\\{ c | c \\in C \\land \\lnot(c \\in BS \\land c.kind = \"tracing\") \\land \\exists l ( l \\in L \\land l.sourceComponent = c \\land l.targetEndpoint \\in ts.E \\land ts \\in BS \\land ts.kind \"tracing\")  \\}| }{ |\\{ c | c \\in C \\land \\lnot(c \\in BS \\land c.kind = \"tracing\") \\}|  }",
        "sources": ["Ntentos2020", "Ntentos2021"],
        "applicableEntities": [ENTITIES.COMPONENT, ENTITIES.SYSTEM, ENTITIES.REQUEST_TRACE],
    },
    "ratioOfServicesThatProvideHealthEndpoints": {
        ...
        "calculationFormula": "\\frac{ | \\{ s | s \\in S \\land \\exists e ( e \\in s.E \\land e.health\\_check = true ) \\} | } {|S|} ",
        "sources": ["Ntentos2022"],
        "applicableEntities": [ENTITIES.COMPONENT, ENTITIES.SYSTEM, ENTITIES.REQUEST_TRACE],
    },
    "ratioOfServicesThatProvideReadinessEndpoints": {
        ...
        "calculationFormula": "\\frac{ | \\{ s | s \\in S \\land \\exists e ( e \\in s.E \\land e.readiness\\_check = true ) \\} | } {|S|} ",
        "sources": ["new"],
        "applicableEntities": [ENTITIES.COMPONENT, ENTITIES.SYSTEM, ENTITIES.REQUEST_TRACE],
    },
    ...
    "numberOfLinksPerComponent": {
        ...
        "calculationFormula": "|\\{ l | l \\in L \\land (l.sourceComponent = c \\lor l.targetEndpoint \\in c.E ) \\} | ",
    ...
    "incomingOutgoingRatioOfAComponent": {
        ...
        "calculationFormula":  "\\frac{|\\{ l | l \\in L \\land l.sourceComponent = c \\} | }{ | \\{ l | l \\in L \\land l.targetEndpoint \\in c.E  \\} | }",
        "sources": ["Tiwari2014"],
        "applicableEntities": [ENTITIES.COMPONENT],
    },
    "ratioOfOutgoingLinksOfAService": {
        ...
        "calculationFormula": "\\frac{|\\{ l | l \\in L \\land l.sourceComponent = c \\} | }{ |\\{ l | l \\in L \\land (l.sourceComponent = c \\lor l.targetEndpoint \\in c.E ) \\} | } * 100",
    ...
    "numberOfSynchronousCycles": {
        ...
        "calculationFormula": "| \\Set{ (l_1,l_2,...,l_n) | \\forall l_i \\in L (l_i.targetEndpoint.kind = \"query\" \\lor l_i.targetEndpoint.kind = \"command\") \\land l_n.targetEndpoint \\in l_1.sourceComponent.E } |",
        "sources": ["Engel2018"],
        "applicableEntities": [ENTITIES.SYSTEM],
    },
    ...
    "numberOfPotentialCyclesInASystem": {
        ...
        "calculationFormula": "| \\Set{ (l_1,l_2,...,l_n) | \\forall l_i \\in L \\land l_n.targetEndpoint \\in l_1.sourceComponent.E } |",
        "sources": ["Peng2022"],
        "applicableEntities": [ENTITIES.SYSTEM],
    },
    ...
    "numberOfCyclesInRequestTraces": {
        ...
        "calculationFormula": "| \\Set{ (l_1,l_2,...,l_n) | \\forall l_i \\in L \\land \\forall l_i \\exists rt.involvedLinks ( l_i \\in rt.involvedLinks.links \\land l_n.targetEndpoint \\in l_1.sourceComponent.E } |",
        "sources": ["Peng2022", "Gamage2021"],
        "applicableEntities": [ENTITIES.REQUEST_TRACE],
    },
