...
class Infrastructure {
     ...
     */
    addBackingDataEntity(backingDataEntity: BackingData, usageRelation: DataUsageRelation) {
        this.#backingDataEntities.push({backingData: backingDataEntity, relation: usageRelation });
