...
export function triggerDownload(content: string, mediaType: string, fileName: string) {
    // download (taken from https://stackoverflow.com/a/22347908)
    let downloadElement = document.createElement("a");
    downloadElement.setAttribute('href', `data:${mediaType};charset=utf-8,` + encodeURIComponent(content));
